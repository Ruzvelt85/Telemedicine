...
{
    public class DoctorListRequestDtoValidatorTests
    {
        private readonly DoctorListRequestDto _defaultModel;
        private readonly DoctorListRequestDtoValidator _validator;

        public DoctorListRequestDtoValidatorTests()
        {
            _defaultModel = new DoctorListRequestDto
            {
                Paging = new PagingRequestDto(),
                Filter = new DoctorListFilterRequestDto()
            };
            _validator = new DoctorListRequestDtoValidator();
        }
