...
{
    public class NextAppointmentsSpecificationTests
    {
        public static IEnumerable<object[]> GetAppointmentDataForNextAppointmentsSpecificationTests()
        {
            yield return new object[]
            {
                "Next appointments found",
        ...
        [Theory]
        [MemberData(nameof(GetAppointmentDataForNextAppointmentsSpecificationTests))]
        ...
        public void NextAppointmentsSpecificationTest(string message, DateTime[] startDates, int foundQuantity)
        {
            ...
            var specification = new NextAppointmentsSpecification(DateTime.UtcNow);
