...
{
    public class PulseRateMeasurementWriteRepository : WriteRepository<PulseRateMeasurement>, IPulseRateMeasurementWriteRepository
    {
        public PulseRateMeasurementWriteRepository(HealthMeasurementDomainServiceDbContext context) : base(context)
        {
        }
    }
}
